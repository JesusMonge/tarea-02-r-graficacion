...
ggtitle("Casos positivos de COVID-19 en Centroamérica y Dominicana") +
xlab("País") + 
...
ggtitle("Casos recuperados de COVID-19 en Centroamérica y Dominicana") +
xlab("País") + 
...
ggtitle("Casos activos de COVID-19 en Centroamérica y Dominicana") +
xlab("País") + 
ylab("Casos activos") +  
geom_col() +
...
ggtitle("Casos fallecidos de COVID-19 en Centroamérica y Dominicana") +
xlab("País") + 
...
```{r}
library(reshape2)
df <- ca_covid19 <- read.csv(file='https://raw.githubusercontent.com/pf0953-programaciongeoespacialr-2020/datos/master/covid19/casos/ca/2020_09_15_CSV_GENERAL.csv')
dfm <- melt(df[,c('pais','fallecidos','recuperados','activos','positivos')],id.vars=1)
library(ggplot2)
ggplot(dfm,aes(x=pais,y=value))+
